...
urlpatterns = [
    ...
    # 2 学生：进入系统公告 ~~~~ 2
    re_path(r'^stu_home/stu_notice/stu_notice_sys/(\d+)', views.stu_notice_sys, name="stu_notice_sys"),
    ...
    # 系统公告
    re_path(r'^org_home/org_notice/org_notice_sys/(\d+)', views.org_notice_sys, name="org_notice_sys"),
    # 活动公告
    re_path(r'^org_home/org_notice/org_notice_act/(\d+)', views.org_notice_sys, name="org_notice_sys"),
    # 2 组织者：查看已发活动 -----（秦浩廷）~~~~~
