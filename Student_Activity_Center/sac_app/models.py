...
class students(models.Model):
    # 学生账号
    stu_id = models.CharField(max_length=1024)
    # 学生姓名
    stu_name = models.CharField(max_length=1024)
    # 学生登入密码
    stu_password = models.CharField(max_length=1024)
    # 学生邮箱
    stu_Email = models.EmailField(max_length=1024)
    # 学生号码
    stu_phone = models.CharField(max_length=128, null=True)
    # 学生性别
    stu_gender = models.CharField(max_length=128)
    # 学生学院
    stu_college = models.CharField(max_length=1024, null=True)
    # 学生专业
    stu_major = models.CharField(max_length=1024, null=True)
    # 学生年级
...
class activities(models.Model):
    # 活动ID
    act_id = models.CharField(max_length=1024)
    # 社团名字
    org_name = models.CharField(max_length=1024,null=True)
    # 活动名称
    act_name = models.CharField(max_length=1024, blank=False)
    # 活动开始时间
    act_start_time = models.DateField(default=1970 - 1 - 1, blank=False)
    # 活动结束时间
    act_end_time = models.DateField(default=1970 - 1 - 1, blank=False)
    # 活动负责人名字
    act_organizer_name = models.CharField(max_length=1024, null=True)
    # 活动社团表间关系
    act_organizer = models.ForeignKey('organizers', on_delete=models.PROTECT)
    # 活动负责人联系方式
    act_organizer_phone = models.CharField(max_length=128, blank=False)
    # 活动类型 单人0 ，组队1
...
class activities_modified(models.Model):
    ...
    # act_organizer = models.ForeignKey('organizers', on_delete=models.PROTECT)
    # 活动负责人联系方式
    act_organizer_phone = models.CharField(max_length=1024, blank=False)
    # 活动类型 单人0 ，组队1
    act_type = models.IntegerField()
    # 活动已创建队伍
...
class managers(models.Model):
    ...
    # 管理员登入密码
    man_password = models.CharField(max_length=128)
...
class organizers(models.Model):
    ...
    # 组织姓名
    org_name = models.CharField(max_length=128, blank=False)
    # 组织负责人姓名
    org_header_name = models.CharField(max_length=128, blank=False)
    # 组织账号密码
    org_password = models.CharField(max_length=128)
    # 组织负责人联系方式
    org_header_phone = models.CharField(max_length=32, blank=False)
    # 组织负责人所在学院
    org_header_college = models.CharField(max_length=1024, null=True)
    # 组织简介
...
class organizers_modified(models.Model):
    org_id = models.CharField(max_length=128, null=True)
    org_password = models.CharField(max_length=128)
    org_name = models.CharField(max_length=128)
    org_header_name = models.CharField(max_length=1024)
    org_header_phone = models.CharField(max_length=128)
    org_header_college = models.CharField(max_length=1024)
...
class teams(models.Model):
    ...
    # 队长名
    team_header_name = models.CharField(max_length=128)
    # 队长联系方式
    team_header_phone = models.CharField(max_length=128)
    # 队成员
    ...
    team_introduction = models.CharField(max_length=1024, null=True)
...
class notices(models.Model):
    ...
    # 活动公告ID
    notices_act_id = models.IntegerField(null=True)
    # 创建公告时间
...
class bbs_comments(models.Model):
    bbs_id = models.CharField(max_length=128)
...
class stu_directMessages(models.Model):
    send_id = models.CharField(max_length=128)
    message = models.TextField()
    accept_id = models.CharField(max_length=128)
